...
const cex = ['aax','aax_futures','abcc','abit','acdx','acdx_futures','ace','aex','allcoin','alpha_five','alterdice','altilly','altmarkets','aprobit','artisturba','atomars','b2bx','bakkt','bankera','basefex','bcex','beaxy','bgogo','bibo','bibox','bibox_futures','bidesk','bigone','bigone_futures','biki','biki_futures','bilaxy','binance','binance_futures','binance_jersey','binance_us','bingx','equos','bione','bit2c','bitalong','bitazza','bitbank','bitbay','bitbns','bitbox','bitci','bitcoin_com','bit_com_futures','bitex','bitexbook','bitexlive','bitfex','bitfinex','bitfinex_futures','bitflyer','bitflyer_futures','bitforex','bitforex_futures','bitget','bitget_futures','bithash','bitholic','bithumb','bithumb_futures','bithumb_global','bitinfi','bitinka','bitkonan','bitkub','bitmake','bitmart','bitmax','bitmax_futures','bitmesh','bitmex','bitmex_spot','bitoffer','bitonbay','bitopro','bitpanda','bitrabbit','bitunix','altcointrader','delta_spot','bitrue','bits_blockchain','bitsdaq','bitso','bitsonic','lcx','bitstamp','bitsten','bitstorage','bittrex','bitubu','bit_z','bitz_futures','bkex','bleutrade','blockchain_com','boa','braziliex','btc_alpha','btcbox','btcc','btc_exchange','btcmarkets','btcmex','btcnext','btcsquare','btc_trade_ua','btcturk','btse','btse_futures','bullish_com','buyucoin','bvnex','bw','flybit','bybit','bydfi','c2cx','catex','cbx','ccex','cex','chainex','changelly','chiliz','coinzoom','citex','cme_futures','coinall','coinasset','coinbene','coinbig','coinbit','coincheck','coindcx','coindeal','coindirect','coineal','coin_egg','coinex','coinfalcon','coinfield','coinflex','coinflex_futures','coinfloor','coingi','coinhe','coinhub','coinjar','coinlim','coinlist','coinmargin','coin_metro','coinone','coinpark','coinplace','coinspro','coinsbank','coinsbit','coinstore','coinsuper','cointiger','cointiger_futures','cointr','coinw','coinxpro','coinzix','coinzo','c_patex','cpdax','crex24','crxzone','cryptaldash','cryptex','cryptlocex','crypto_com','kickex','cryptology','crytrex','c_trade','currency','darb_finance','daybit','dcoin','decoin','delta_futures','deribit','dextrade','difx','digifinex','dobitrade','dove_wallet','dragonex','dsx','duedex','ecxx','elitex','emirex','eterbase','etherflyer','etorox','exmarkets','exmo','exnce','exrates','exx','fairdesk','fatbtc','fastex','fex','financex','finexbox','floatsv','freiexchange','ftx','ftx_spot','ftx_us','gate','gate_futures','gbx','gdac','gdax','gemini','getbtc','gmo_japan','gmo_japan_futures','gobaba','goku','gopax','graviex','hanbitco','hbtc','hbtc_futures','hb_top','hitbtc','hoo','hopex','hotbit','hpx','hubi','huobi','huobi_dm','huobi_id','huobi_japan','huobi_korea','huobi_thailand','ice3x','idcm','incorex','independent_reserve','indodax','infinity_coin','instantbitex','iqfinex','itbit','jex','jex_futures','kanga','kkcoin','k_kex','korbit','kraken','kraken_futures','kucoin','kumex','kuna','lakebtc','latoken','lbank','liquid_derivatives','localtrade','lucent','lukki','luno','lykke','max_maicoin','mercado_bitcoin','mercatox','mercuriex','multi','mxc','mxc_futures','mycoinstory','namebase','nami_exchange','nanu_exchange','narkasa','negociecoins','neraex','nice_hash','nlexch','nominex','novadax','oceanex','okcoin','okex','okex_korea','okex_swap','omgfin','omnitrade','otcbtc','ovex','p2pb2b','paribu','paroexchange','paymium','phemex','phemex_futures','pointpay','poloniex','poloniex_futures','prime_xbt','pionex','probit','qtrade','quoine','resfinex','rfinex','safe_trade','satoexchange','secondbtc','shortex','simex','sinegy','zbx','sistemkoin','six_x','south_xchange','stake_cube','stocks_exchange','stormgain','stormgain_futures','swiftex','tarmex','tdax','therocktrading','thodex','tidebit','tidex','tokenize','tokenomy','tokens_net','toko_crypto','tokok','tokpie','toobit','topbtc','trade_ogre','txbit','unnamed','upbit','upbit_indonesia','valr','vb','vcc','vebitcoin','velic','vindax','vinex','virgox','waves','wazirx','whale_ex','whitebit','xcoex','xfutures','xt','yobit','yunex','zaif','zb','zbg','zbg_futures','zebitex','zebpay','zg','zgtop','zipmex','biconomy','wootrade','bitexen','probit_kr','bybit_spot','qmall']
const dex = ['aave','allbit','anyswap','bakeryswap','balancer','balancer_v1','bamboo_relay','bancor','bancor_v3','bepswap','binance_dex','binance_dex_mini','birake','bisq','bitcratic','blockonix','bscswap','burgerswap','compound_finance','cream_swap','cream_swap_v1','curve','curve_ethereum','curve_arbitrum','curve_optimism','wault_swap','cybex','ddex','dem_exchange','deversifi','dex_blue','dodo','dodo_polygon','dodo_arbitrum','dolomite','dydx','dydx_perpetual','defi_swap','zero_exchange','value_liquid_bsc','apeswap','comethswap','unicly','sunswap_v1','sushiswap_fantom','polyzap','ethex','everbloom','forkdelta','swop_fi','secretswap','pantherswap','zilswap','dydx_perpetual_l1','futureswap','honeyswap','spookyswap','idex','dodo_bsc','joyso','jupiter','justswap','kyber_network','kyberswap_elastic_arbitrum','zkswap','leverj','linkswap','loopring','loopring_amm','luaswap','dmm','sushiswap_polygon','swapr','mdex_bsc','ubeswap','sushiswap_xdai','mcdex','mdex','mesa','mirror','mooniswap','nash','viperswap','neblidex','newdex','nexus_mutual','oasis_trade','one_inch','one_inch_liquidity_protocol','spiritswap','orderbook','pancakeswap','pangolin','paraswap','raydium','perpetual_protocol','polyient_dex','quickswap','quickswap_v3','julswap','radar_relay','sakeswap','sashimiswap','saturn_network','serum_dex','serumswap','spacefi_zksync','stellar_term','streetswap','sushiswap','switcheo','synthetix','tokenlon','token_sets','tomodex','dfyn','levinswap_xdai','thena-fusion','tron_trade','trx_market','uniswap','uniswap_v1','uniswap_v2','uniswap_v3','uniswap_v3_arbitrum','vitex','value_liquid','zero_ex','pancakeswap_others','pancakeswap_new','pancakeswap-v3-ethereum','pancakeswap-v3-bsc','kuswap','shibaswap','osmosis','waultswap_polygon','orca','honeyswap_polygon','swapr_ethereum','syncswap','pinkswap','pulsex','thorswap','thorwallet','traderjoe','traderjoe-v2-1-avalanche','ref_finance','mimo','sushiswap_arbitrum','balancer_polygon','sushiswap_harmony','baguette','cherryswap','acsi_finance','velocore','velodrome-finance-v2','woofi']
...
export const affiliate_links = urls => toArray(urls).map(url => {
  try {
    const u = new URL(url)
    const hostname = u.hostname
    if (hostname === 'www.binance.com' || hostname === 'www.binance.us') {
      url = `${u.protocol}//${hostname}${u.pathname}${referrals.binance?.code ? `?ref=${referrals.binance.code}` : ''}`
    }
    else if (hostname === 'www.coinbase.com') {
      url = `${u.protocol}//coinbase-consumer.sjv.io/c/2664740/552039${referrals.coinbase?.code ? `/${referrals.coinbase.code}` : ''}`
    }
    else if (hostname === 'r.kraken.com' || hostname === 'futures.kraken.com') {
      if (!u.pathname.includes('/dashboard')) {
        url = `${u.protocol}//r.kraken.com/c/2664740/741638${referrals.kraken?.code ? `/${referrals.kraken.code}` : ''}`
      }
    }
    else if (hostname === 'www.bitfinex.com') {
      url = `${u.protocol}//${hostname}${u.pathname}${referrals.bitfinex?.code ? `?refcode=${referrals.bitfinex.code}` : ''}`
    }
    else if (hostname === 'gate.io' || hostname === 'www.gate.io') {
      url = `${u.protocol}//${hostname}${u.pathname.includes('trade/') ? `${u.pathname}${referrals.gate?.code ? `?ref=${referrals.gate.code}` : ''}` : `/signup${referrals.gate?.code ? `/${referrals.gate.code}` : ''}`}`
    }
    else if (hostname === 'ftx.com' || hostname === 'ftx.us') {
      if (!u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}${referrals.ftx?.code ? `/#a=${referrals.ftx.code}` : ''}`
      }
    }
    else if (hostname === 'crypto.com') {
      if (!u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}${u.pathname}${referrals.crypto?.code ? `/${referrals.crypto.code}` : ''}`
      }
    }
    else if (hostname === 'gemini.sjv.io') {
      // url = `${u.protocol}//${hostname}${referrals.gemini?.code ? `/${referrals.gemini.code}` : ''}`
      url = `${u.protocol}//www.gemini.com`
    }
    else if (hostname === 'www.huobi.com' || hostname === 'www.hbdm.com' || hostname === 'dm.huobi.com') {
      url = `${u.protocol}//www.huobi.com/en-us/topic/invited${referrals.houbi_global?.code ? `/?invite_code=${referrals.huobi_global.code}` : ''}`
    }
    else if (hostname === 'www.okex.com') {
      if (!u.pathname.includes('/market') && !u.pathname.includes('/future') && !u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}/join${referrals.okex?.code ? `/${referrals.okex.code}` : ''}`
      }
      else if (u.pathname.includes('/market')) {
      ...
      if (!u.pathname.includes('/trade') || hostname === 'futures.kucoin.com') {
        url = `${u.protocol}//www.kucoin.com/ucenter/signup${referrals.kucoin?.code ? `?rcode=${referrals.kucoin.code}` : ''}`
      }
    }
      ...
      if (!u.pathname.includes('/exchange') && !u.pathname.includes('/futures')) {
        url = `${u.protocol}//${hostname}/signup${referrals.poloniex?.code ? `?c=${referrals.poloniex.code}` : ''}`
      }
    }
    else if (hostname === 'latoken.com') {
      if (!u.pathname.includes('/exchange')) {
        url = `${u.protocol}//${hostname}/invite${referrals.latoken?.code ? `?r=${referrals.latoken.code}` : ''}`
      }
    }
    else if (hostname === 'bithumb.pro') {
      url = `${u.protocol}//${hostname}/register${referrals.bithumb_pro?.code ? `?i=${referrals.bithumb_pro.code}` : ''}`
    }
    else if (hostname === 'www.bitkub.com') {
      if (!u.pathname.includes('/market')) {
        url = `${u.protocol}//${hostname}/signup${referrals.bitkub?.code ? `?ref=${referrals.bitkub.code}` : ''}`
      }
    }
      ...
      if (!u.pathname.includes('/trade') && !u.hash.includes('/trade')) {
        url = `${u.protocol}//${hostname}/register${referrals.bkex?.code ? `/${referrals.bkex.code}` : ''}`
      }
    }
      ...
      if (!u.pathname.includes('/trading') && !u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}/activity/task/task-landing?cn=900000${referrals.bitrue?.code ? `&inviteCode=${referrals.bitrue.code}` : ''}`
      }
      else if (u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}${u.pathname}${referrals.bitrue?.code ? `?inviteCode=${referrals.bitrue.code}` : ''}`
      }
    }
      ...
      if (!u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}/register${referrals.bitmex?.code ? `/${referrals.bitmex.code}` : ''}`
      }
    }
    else if (hostname === 'www.bybit.com') {
      if (u.pathname.includes('/exchange')) {
        url = `${u.protocol}//${hostname}${u.pathname}?language=en-US&group_id=0&group_type=1${referrals.bybit?.code ? `&affiliate_id=${referrals.bybit.code}` : ''}`
      }
      else {
        url = `${u.protocol}//partner.bybit.com/b${referrals.bybit?.code ? `/${referrals.bybit.code}` : ''}`
      }
    }
    else if (hostname === 'cex.io') {
      url = `${u.protocol}//${hostname}/r/0${referrals.cex?.code ? `/${referrals.cex.code}/0/` : ''}`
    }
    else if (hostname === 'pro.changelly.com') {
      url = `${u.protocol}//changelly.com${u.search ? u.search.toLowerCase() : '?from=btc&to=usdt'}&amount=0.1${referrals.changelly?.code ? `&ref_id=${referrals.changelly.code}` : ''}`
    }
      ...
      url = `${u.protocol}//${hostname}${u.pathname}${u.search ? `${u.search}&` : '?'}${referrals.bitmart?.code ? `r=${referrals.bitmart.code}` : ''}`
    }
    else if (hostname === 'www.mxc.com') {
      if (!u.pathname.includes('/trade')) {
        url = `${u.protocol}//${hostname}/auth/signup${referrals.mxc?.code ? `?inviteCode=${referrals.mxc.code}` : ''}`
      }
    }
    else if (hostname === 'pro.coinlist.co') {
      if (!u.pathname.includes('/trader')) {
        url = `${u.protocol}//coinlist.co/clt${referrals.coinlist?.code ? `?referral_code=${referrals.coinlist.code}` : ''}`
      }
    }
    // not on list
    else if (hostname === 'www.xcoins.com') {
      url = `${u.protocol}//${hostname}/2020/r.php${referrals.xcoins?.code ? `?id=${referrals.xcoins.code}` : ''}`
    }
    else if (hostname === 'paxful.com') {
      url = `${u.protocol}//${hostname}/${referrals.paxful?.code ? `?r=${referrals.paxful.code}` : ''}`
    }
    else if (hostname === 'www.coinmama.com') {
      // wait
    }
    else if (hostname === 'changenow.io') {
      url = `${u.protocol}//${hostname}${referrals.changenow?.code ? `?link_id=${referrals.changenow.code}` : ''}`
    }
  } catch (error) {}
  return url
})
...
export const trade_url = t =>
  !t.trade_url && t.market?.identifier === 'bitstamp' ?
    ...
    t.trade_url?.includes('www.bitrue.com') ?
...
export const trades = (token, tokens, tickers = []) => {
  ...
  if (id) {
    data = _.orderBy(
      custom_trades.map(e => {
        let tickers_urls = toArray(tickers).filter(t => t.market?.identifier === e.id && t.trade_url && t.base && equalsIgnoreCase(t.base, symbol))
        tickers_urls = tickers_urls.findIndex(t => equalsIgnoreCase(t.target, default_target)) > -1 ? tickers_urls.filter(t => equalsIgnoreCase(t.target, default_target)) : tickers_urls
        return {
          exchange: toArray(tokens?.exchanges).find(_e => _e.id === e.id) || e,
          url: affiliate_links(e.support_pairs.findIndex(c => c.base === id) > -1 ? e.trade_url.replace('{base}', e.isUpperCase ? (symbol || id).toUpperCase() : (symbol || id).toLowerCase()).replace('{target}', e.isUpperCase ? e.default_target?.toUpperCase() : e.default_target?.toLowerCase()) : (_.head(tickers_urls)?.trade_url || e.url)),
